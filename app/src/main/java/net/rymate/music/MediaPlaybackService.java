...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "net.rymate.music.playstatechanged";
    public static final String META_CHANGED = "net.rymate.music.metachanged";
    public static final String QUEUE_CHANGED = "net.rymate.music.queuechanged";

    public static final String SERVICECMD = "net.rymate.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "net.rymate.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "net.rymate.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "net.rymate.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "net.rymate.music.musicservicecommand.next";
    public static final String STOP_ACTION = "net.rymate.music.musicservicecommand.stop";
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                play();
            } else if (CMDSTOP.equals(cmd) || STOP_ACTION.equals(cmd)) {
                pause();
                mPausedByTransientLossOfFocus = false;
                seek(0);
     ...
     * "net.rymate.music.metachanged"
     * "net.rymate.music.queuechanged",
     * "net.rymate.music.playbackcomplete"
     * "net.rymate.music.playstatechanged"
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            if (what.equals(PLAYSTATE_CHANGED)) {
                ...
                if (b != null) {
                    ...
                    b = BitmapFactory.decodeResource(getResources(), R.drawable.albumart_mp_unknown);
                    ed.putBitmap(MetadataEditor.BITMAP_KEY_ARTWORK, b);
                }
                ed.apply();
            }
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            // This is mostly so that if you pr ess 'play' on a bluetooth headset
    ...
    private void updateNotification() {
        ...
        PendingIntent mPauseIntent = PendingIntent.getBroadcast(this, 0,
                new Intent(TOGGLEPAUSE_ACTION),
                PendingIntent.FLAG_CANCEL_CURRENT);

        PendingIntent mNextIntent = PendingIntent.getBroadcast(this, 0,
                new Intent(NEXT_ACTION),
                PendingIntent.FLAG_CANCEL_CURRENT);

        PendingIntent mPrevIntent = PendingIntent.getBroadcast(this, 0,
                new Intent(PREVIOUS_ACTION),
                PendingIntent.FLAG_CANCEL_CURRENT);

        PendingIntent mStopIntent = PendingIntent.getBroadcast(this, 0,
                new Intent(PAUSE_ACTION),
                PendingIntent.FLAG_CANCEL_CURRENT);


        RemoteViews contentView = new RemoteViews(getPackageName(), R.layout.notification_small);
        contentView.setImageViewBitmap(R.id.image, b);
        contentView.setTextViewText(R.id.title, track);
        contentView.setTextViewText(R.id.text, "By " + artist + " - " + album);
        contentView.setOnClickPendingIntent(R.id.nextButton, mNextIntent);
        contentView.setOnClickPendingIntent(R.id.pauseButton, mPauseIntent);
        contentView.setImageViewResource(R.id.pauseButton, isPlaying() ? android.R.drawable.ic_media_pause : android.R.drawable.ic_media_play);

        RemoteViews largeContentView = new RemoteViews(getPackageName(), R.layout.notification_large);
        largeContentView.setImageViewBitmap(R.id.image, b);
        largeContentView.setTextViewText(R.id.title, track);
        largeContentView.setTextViewText(R.id.text, "By " + artist + " - " + album);
        largeContentView.setOnClickPendingIntent(R.id.nextButton, mNextIntent);
        largeContentView.setOnClickPendingIntent(R.id.prevButton, mPrevIntent);
        largeContentView.setOnClickPendingIntent(R.id.pauseButton, mPauseIntent);
        largeContentView.setImageViewResource(R.id.pauseButton, isPlaying() ? android.R.drawable.ic_media_pause : android.R.drawable.ic_media_play);
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(this)
                ...
                .setContentText("By " + artist + " - " + album)
        ...
        notification.setContentIntent(PendingIntent.getActivity(this, 0, resultIntent
                        .addFlags(Intent.FLAG_ACTIVITY_PREVIOUS_IS_TOP), 0));

        // mId allows you to update the notification later on.
        Notification music = notification.build();

        mNotificationManager.notify(
                NOTIFICATION_ID,
                music);

        //startForeground(PLAYBACKSERVICE_STATUS, music);
    }
